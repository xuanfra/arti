		...
		<div id="pagina">
			...
			<div align="center">
				...
				<tr>
					...
					<td width="55%" rowspan="15" align="left" valign="top">
		...
		<option value="<?php echo mysql_result($res_proveedores,$contador,"codproveedor")?>"><?php echo mysql_result($res_proveedores,$contador,"nif")?> -- <?php echo mysql_result($res_proveedores,$contador,"nombre")?></option>
					...
					<?php
					  ...
					  <tr>
						...
						<tr>
							<td>Fecha de alta</td>
							<td><input NAME="fecha" type="text" class="cajaPequena" id="fecha" size="10" maxlength="10" readonly> <img src="../images/calendario.png" name="Image1" id="Image1" width="16" height="16" border="0" id="Image1" onMouseOver="this.style.cursor='pointer'">
        <script type="text/javascript">
					Calendar.setup(
					  {
					inputField : "fecha",
					  ...
					  ?>
						<tr>
							...
							<option value="0">Todos los embalajes</option>
								<?php #Fix Warning: mysql_result(): Unable to jump to row 7 on MySQL result index 11 in /var/www/html/maxcodekarev/articulos/nuevo_articulo.php on line 260
								...
								<?php echo mysql_result($res_embalaje,$contador,"codembalaje")?>
						</td>
					   </tr>
...
<!--					  	<tr>
						  <td>Pvp</td>
						  <td><input NAME="qpvp" type="text" class="cajaPequena" id="pvp" size="10" maxlength="10"><?php echo $simbolomoneda ?></td>
			      </tr>
-->
				  <tr>
