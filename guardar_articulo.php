...
$referencia=$_REQUEST["Areferencia"];
$codfamilia=$_REQUEST["AcboFamilias"];
$descripcion=$_REQUEST["Adescripcion"];
$codimpuesto=$_REQUEST["AcboImpuestos"];
$codproveedor1=$_REQUEST["acboProveedores1"];
$codproveedor2=$_REQUEST["acboProveedores2"];
$descripcion_corta=$_REQUEST["Adescripcion_corta"];
$codubicacion=$_REQUEST["AcboUbicacion"];
$stock_minimo=$_REQUEST["nstock_minimo"];
$stock=$_REQUEST["nstock"];
$aviso_minimo=$_REQUEST["aaviso_minimo"];
$datos=$_REQUEST["adatos"];
$fecha=$_REQUEST["fecha"];
$fechalis=$fecha;
if ($fecha<>"") { $fecha=explota($fecha); } else { $fecha="0000-00-00"; }
$codembalaje=$_REQUEST["AcboEmbalaje"];
$unidades_caja=$_REQUEST["nunidades_caja"];
$precio_ticket=$_REQUEST["aprecio_ticket"];
$modif_descrip=$_REQUEST["amodif_descrip"];
$modificar_ticket = $modif_descrip;//para corrgir Notice: Undefined variable: modificar_ticket in /var/www/html/maxcodeka/articulos/guardar_articulo.php on line 67 
$observaciones=$_REQUEST["aobservaciones"];
$precio_compra=$_REQUEST["qprecio_compra"];
$precio_almacen=$_REQUEST["qprecio_almacen"];
$precio_tienda=$_REQUEST["qprecio_tienda"];
//$pvp=$_REQUEST["qpvp"];
$precio_iva=$_REQUEST["qprecio_iva"];
$codigobarras=$_REQUEST["barras"];
//$foto=$_REQUEST["foto"];

$codarticulo=$_REQUEST["id"];
$foto = $codarticulo;
$foto_name  = $foto_name = "foto".$codarticulo.".jpg"; 
...
//		};
	...
	if ($rs_actualizar) { $mensaje = "El articulo ha sido dado de alta correctamente"; }
				...
				<div id="frmBusqueda">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						...
						<tr>
							...
							<td width="27%" rowspan="11" align="center" valign="top"><img src="../fotos/
									<?php  if (is_file('../fotos/'.$foto_name)){  
											echo $foto_name; 
									  	}else {
											echo "no_foto_arti.png";
										}
									?>" width="160px" height="140px" border="1"></td>
						</tr>
						<tr>
